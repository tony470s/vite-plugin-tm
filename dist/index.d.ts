...
declare const tmHeaderKeys: readonly ["name", "name:en", "name:zh", "name:zh-cn", "version", "description", "description:en", "description:zh", "description:zh-cn", "author", "namespace", "license", "include", "require", "homepage", "homepageURL", "website", "source", "icon", "iconURL", "defaulticon", "icon64", "icon64URL", "updateURL", "downloadURL", "supportURL", "match", "exclude", "resource", "connect", "run-at", "grant", "noframes", "unwrap", "nocompat", "antifeature"];
declare type RunAt = 'document-start' | 'document-body' | 'document-end' | 'document-idle' | 'context-menu';
declare type AntiFeature = 'ads' | 'tracking' | 'miner';
